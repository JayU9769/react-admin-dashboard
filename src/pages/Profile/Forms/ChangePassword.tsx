...
import { defaultAdmin, defaultProfileChangePassword, IProfileChangePassword } from "@/interfaces/admin";
...
const ChangePassword: React.FC = () => {
  ...
  const [formData] = useState<IProfileChangePassword>(defaultProfileChangePassword);
        ...
        <CardContent>
          <form onSubmit={formik.handleSubmit}>
            <div className="mb-3">
              ...
              <Input id="currentPassword" name="currentPassword" type="password" onChange={formik.handleChange} value={formik.values.currentPassword} onBlur={formik.handleBlur} autoComplete="off" placeholder="* * * * * * * * * *" />
              <div className={`min-h-4`}>{formik.touched.currentPassword && formik.errors.currentPassword && <InputErrorMessage message={formik.errors.currentPassword} />}</div>
            </div>
            <div className="mb-3">
              <Label>
                New Password <span className="text-destructive">*</span>
              </Label>
              <Input id="newPassword" name="newPassword" type="password" onChange={formik.handleChange} value={formik.values.newPassword} onBlur={formik.handleBlur} autoComplete="off" placeholder="* * * * * * * * * *" />
